...
| Code output | AI-written executive briefing |
...
| AI Briefing | Executive summary generated by Gemini 2.5 Flash |
...
**+24 percentage point recall improvement** over
default model configuration through three techniques:
class balancing, threshold tuning, and ensemble boosting.

**Why recall is the priority metric:**
Missing a churner costs ~$778/year (avg LTV).
...
Projected savings: $145,411–$436,234 annually.
